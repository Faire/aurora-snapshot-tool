...
# This lambda function will delete manual snapshots that have expired in the region specified in the environment variable DEST_REGION, and according to the environment variables SNAPSHOT_PATTERN and RETENTION_DAYS.
...
def lambda_handler(event, context):
    ...
    filtered_list = get_own_snapshots_no_x_account(SNAPSHOT_PATTERN, response, DEST_REGION)
